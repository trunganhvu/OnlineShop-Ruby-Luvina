	...
	<div id="page-container" class="main-admin">
		...
		<div class="side-bar">
			<div class="side-bar-links">
				...
				<ul class="navbar-nav">
					<li class="nav-item"><a href="home.htm" class="nav-links d-block"><i
							class="fa fa-home pr-2"></i> HOME</a></li>
					<li class="nav-item"><a href="productlinetable.htm" class="nav-links d-block"><i
							class="fa fa-home pr-2"></i> Product Lines</a></li>
					<li class="nav-item"><a href="producttable.htm" class="nav-links d-block"><i
							class="fa fa-home pr-2"></i> Products</a></li>
					<li class="nav-item"><a href="#" class="nav-links d-block"><i
							class="fa fa-home pr-2"></i> Orders</a></li>
				</ul>
			</div>
			<div class="side-bar-icons">
				...
				<div class="icons d-flex flex-column align-items-center">
					<a href="#" class="set-width text-center display-inline-block my-1"><i
						class="fa fa-home"></i></a> <a href="#"
						class="set-width text-center display-inline-block my-1"><i
						class="fa fa-users"></i></a> <a href="#"
						class="set-width text-center display-inline-block my-1"><i
						class="fa fa-list"></i></a> <a href="#"
						class="set-width text-center display-inline-block my-1"><i
						class="fa fa-sticky-note-o"></i></a> <a href="#"
						class="set-width text-center display-inline-block my-1"><i
						class="fa fa-file-text"></i></a> <a href="#"
						class="set-width text-center display-inline-block my-1"><i
						class="fa fa-sticky-note-o"></i></a> <a href="#"
						class="set-width text-center display-inline-block my-1"><i
