...
<body>
	...
	<div class="container" style="padding: 30px;">
		...
		<nav aria-label="..." style="margin-top: 13px;">
		
		  <ul class="pagination">
		  	<c:forEach items="${quantityPage }" var="i">
		    	<li class="page-item" id="${i }"><a class="page-link" href="listproduct-page${i}.htm">${i }</a></li>
		    </c:forEach>
	...
	<script type="text/javascript">
		...
		let res = pathname.substring(pathname.length-5, pathname.length-4);
